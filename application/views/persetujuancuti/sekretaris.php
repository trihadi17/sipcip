                                            ...
                                            <div class="modal-dialog modal-small ">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer text-center">
                                                        <?php echo anchor('persetujuancuti/disetujuisekretaris/' . $pnjgn->id_cuti, '<div type="button" class="btn btn-success btn-round">
                                                <i class="material-icons">check_circle_outline</i>Disetujui
                                    </div>'); ?>
                                                        <?php echo anchor('persetujuancuti/ditolaksekretaris/' . $pnjgn->id_cuti, '<div type="button" class="btn btn-danger btn-round">
