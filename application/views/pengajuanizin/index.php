                            ...
                            <table id="datatables" class="table table-striped table-no-bordered table-hover"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php if ($izin->status == 'Tunggu Persetujuan Kepala Bidang') : ?>
                                        <td class="btn btn-warning btn-sm"><?= $izin->status ?></td>
                                        <?php elseif ($izin->status == 'Ditolak Kepala Bidang') : ?>
                                        ...
                                        <td class="td-actions">
                                            ...
                                            <?php if ($izin->status == "Disetujui Kepala Bidang") : ?>
...
<div class="modal fade" id="myModal" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form method="post" action="<?= base_url('pengajuanizin/tambah') ?>">
