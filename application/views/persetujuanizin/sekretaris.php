                                            ...
                                            <div class="modal-dialog modal-small ">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer text-center">
                                                        <?php echo anchor('persetujuanizin/disetujuisekretaris/' . $pnjgn->id_izin, '<div type="button" class="btn btn-success btn-round">
                                                <i class="material-icons">check_circle_outline</i>Disetujui
                                    </div>'); ?>
                                                        <?php echo anchor('persetujuanizin/ditolaksekretaris/' . $pnjgn->id_izin, '<div type="button" class="btn btn-danger btn-round">
